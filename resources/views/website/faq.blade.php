            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="card ">
                        <div class="card-header">
                            <button class="btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#pqUsar" aria-expanded="false" aria-controls="multiCollapseExample2">
                                Quem somos e por que usar nosso serviço?
                            </button>
                        </div>
                        <div class="collapse multi-collapse" id="pqUsar">
                            <div class="card-body">
                ...
                <div class="col-12 col-lg-6">
                    <details>
                        ...
                        <p>
                            Quando você cria o seu cofrinho, você estabelece uma data de término para arrecadação e quando este dia chegar, iremos notificá-lo com o saldo disponível para saque.
                            ...
                            Há duas opções de saque: na conta do próprio organizador ou na conta de outro destinatário.
                        </p>
                    </details>
                </div>
