@extends('layouts.site.app', ['activePage' => '', 'title' => '| Falha', 'navName' => '', 'activeButton' => ''])
...
<section class="promo-primary">
    ...
    <div class="promo-primary__description"> <span>Falhou</span></div>
    <div class="container">
        <div class="row">
            <div class="col-auto">
                <div class="align-container">
                    <div class="align-container__item">
                        ...
                        <h1 class="promo-primary__title"><span>Falhou</span> <span></span></h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-end">
            <div class="col-xl-12">
                <div class="heading heading--primary"><span class="heading__pre-title"></span>
                    {{-- <h2 class="heading__title"> <span>Falhou</span></h2> --}}
                    <p>
