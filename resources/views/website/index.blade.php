                    ...
                    <div class="slider-holder">
                        <div class="donors-slider donors-slider--style-1">
                            <div class="donors-slider__item">
                                <div class="donors-slider__img"><img src="{{asset('helpo-theme')}}/img/donor_1.png" alt="donor"/></div>
                            </div>
                            <div class="donors-slider__item">
                                <div class="donors-slider__img"><img src="{{asset('helpo-theme')}}/img/donor_2.png" alt="donor"/></div>
                            </div>
                            <div class="donors-slider__item">
                                <div class="donors-slider__img"><img src="{{asset('helpo-theme')}}/img/donor_3.png" alt="donor"/></div>
                            </div>
                            <div class="donors-slider__item">
                                <div class="donors-slider__img"><img src="{{asset('helpo-theme')}}/img/donor_4.png" alt="donor"/></div>
                            </div>
                        </div>
                    </div>
                    <!-- donors slider end-->
    ...
    <section class="section instagram no-padding-bottom">
        ...
        <div class="instagram-slider">
            <a class="instagram-slider__item" href="#">
                ...
                <span class="instagram-slider__icon"><i class="fas fa-instagram" aria-hidden="true"></i></span>
                <span class="instagram-slider__icon-hover"><i class="fa fa-instagram" aria-hidden="true"></i></span>
            </a>
            <a class="instagram-slider__item" href="#">
                <img class="img--bg" src="{{asset('helpo-theme')}}/img/ig_2.jpg" alt="img"/>
                <span class="instagram-slider__icon"><i class="fas fa-instagram" aria-hidden="true"></i></span>
                <span class="instagram-slider__icon-hover"><i class="fa fa-instagram" aria-hidden="true"></i></span>
            </a>
                    
            <a class="instagram-slider__item" href="#"><img class="img--bg" src="{{asset('helpo-theme')}}/img/ig_3.jpg" alt="img"/>
                <span class="instagram-slider__icon"><i class="fas fa-instagram" aria-hidden="true"></i></span>
                <span class="instagram-slider__icon-hover"><i class="fas fa-instagram" aria-hidden="true"></i></span>
            </a>
            <a class="instagram-slider__item" href="#"><img class="img--bg" src="{{asset('helpo-theme')}}/img/ig_4.jpg" alt="img"/>
                <span class="instagram-slider__icon"><i class="fas fa-instagram" aria-hidden="true"></i></span>
                <span class="instagram-slider__icon-hover"><i class="fa fa-instagram" aria-hidden="true"></i></span>
            </a>
            <a class="instagram-slider__item" href="#"><img class="img--bg" src="{{asset('helpo-theme')}}/img/ig_5.jpg" alt="img"/>
                <span class="instagram-slider__icon"><i class="fas fa-instagram" aria-hidden="true"></i></span>
                <span class="instagram-slider__icon-hover"><i class="fa fa-instagram" aria-hidden="true"></i></span>
            </a>
                
            <a class="instagram-slider__item" href="#"><img class="img--bg" src="{{asset('helpo-theme')}}/img/ig_6.jpg" alt="img"/>
                <span class="instagram-slider__icon"><i class="fas fa-instagram" aria-hidden="true"></i></span>
                <span class="instagram-slider__icon-hover"><i class="fa fa-instagram" aria-hidden="true"></i></span>
            </a>
