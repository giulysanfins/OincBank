<div class="row">
            ...
            <div class="col-6 col-nd-6">
                <div class="accordion accordion--primary mb-4 ">
            ...
            <div class="col-6 col-nd-6">
                <div class="accordion accordion--primary mb-4 mt-2">
                    <div class="accordion__title-block">
                        <h6 class="accordion__title">O site é seguro?</h6><span class="accordion__close"></span>
                    </div>
                    <div class="accordion__text-block text-justify">
            ...
            <div class="col-6 col-nd-6">        
                <div class="accordion accordion--primary mb-4 mt-2">
                    ...
                    <div class="accordion__text-block text-justify">
                        <p>
                            As doações podem ser feitas via PIX e cartão de crédito.<br />
            ...
            <div class="col-6 col-nd-6">         
                <div class="accordion accordion--primary mt-2">
                    <div class="accordion__title-block">
                        <h6 class="accordion__title">Qual o prazo para receber o dinheiro?</h6><span class="accordion__close"></span>
                    </div>
                    <div class="accordion__text-block text-justify">
                        <p>Depois de ter escolhido uma das duas opções de saque (conta do organizador ou outro destinatário), 
                            iremos transferir o dinheiro arrecadado em até 3 dias úteis.</p>
                    </div>
                </div>
            </div>
 </div>
