                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="col-12 text-right">
                                    @if (auth()->user()->role == 2)
                                        <a href="{{ route('campanha.store') }}" class="btn btn-primary">Adicionar
                                            Cofrinho</a>
                                        @if ($campanhas->count() != 0)
                                            <a href="{{ route('campanha.apagar_adm') }}" class="btn btn-danger">Deletar
                                                Cofrinho</a>
                                        @endif
                                    @endif
                                </div>
                                ...
                                @if ($campanhas->count() == 0)
                                    <div class="d-flex flex-column w-100 justify-content-center align-items-center"
                                        ...
                                        <i class="far fa-sad-cry mr-4"
                                            style="width:150px; height: 150px; color: #643348;"></i>
                                ...
                                @else
                                    ...
                                    <div class="accordion" id="acoordion_campanhas">
                                        ...
                                        <div class="card">
                                            <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                                data-target="#ativos" aria-expanded="false" aria-controls="collapseThree">
                                        ...
                                        <div class="card">
                                            <button class="btn btn-link" type="button" data-toggle="collapse"
                                                data-target="#desativadas" aria-expanded="false"
                                                aria-controls="header_desativadas">
                                            ...
                                            <div id="desativadas" class="collapse" aria-labelledby="body_desativadas"
                                                data-parent="#desativadas">
                                                <div class="card-body">
                                                                            ...
                                                                            <div class="btn-group float-right" role="group"
                                                                                ...
                                                                                @if (auth()->user()->role == 2)
                                                                                    <button type="button"
                                                                                        ...
                                                                                        valor</button>
                                                                                @endif
                                                                                <a href="{{ route('campanha.ativar', $campanha->id) }}"
                                                                                    class="btn btn-primary">Ativar</a>


                                                                            </div>
                                                                            <a href="#{{ $campanha->id }}" class="edit"
                                                                                data-toggle="modal"><i
                                        ...
                                        @if (auth()->user()->role == 1)
                                            <div class="card">
                                                <button class="btn btn-link" type="button" data-toggle="collapse"
                                                    data-target="#excluidas" aria-expanded="false"
                                                    aria-controls="header_desativadas">
                                                    <div class="card-header" id="header_desativadas">
                                                        <h5 class="mb-0 text-left">
                                                            Cofrinhos Excluidos
                                                ...
                                                <div id="excluidas" class="collapse" aria-labelledby="body_excluidas"
                                                    data-parent="#excluidas">
                                                    <div class="card-body">
                                                                                ...
                                                                                <div class="btn-group float-right"
                                                                                    ...
                                                                                    @if (auth()->user()->role == 2)
                                                                                        <button type="button"
                                                                                            ...
                                                                                            valor</button>
                                                                                        <button type="submit"
                                                                                            class="btn btn-success">Ativar</button>
                                                                                    @endif
                                                                                </div>
                                                                            </td>
                                                                        </tr>
